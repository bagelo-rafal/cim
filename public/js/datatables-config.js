...
$(document).ready(function() {
    var table = $('#customers-table, #diets-table, #reviews-table, #variants-table, #types-table, #addons-table, #menu-table, #workers-table, #dish-table, #zones-table, #places-table').DataTable({
        "language": {
